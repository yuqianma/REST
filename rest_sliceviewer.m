...
function Result =InitControls(AFilename, ACallback)	
	...
	set(theFig, 'DeleteFcn', sprintf('rest_sliceviewer(''Delete'', %g);',theFig.Number)  );
	set(theFig, 'KeyPressFcn', sprintf('rest_sliceviewer(''OnKeyPress'', %g);',theFig.Number)  );
	...
	hCrosshair =uicontrol(theFig, 'Style','checkbox', 'Units','pixels', ...
					...
					'Callback', sprintf('rest_sliceviewer(''Repaint'', %g);',theFig.Number) , ...
					'BackgroundColor', get(theFig,'Color'), ...
					'Position',[theLeft, theBottom+75, 70,15]);
	
	
	theEditCallbackFcn =sprintf('rest_sliceviewer(''SetPosition'', %g);',theFig.Number);
	...
	hMagnify =uicontrol(theFig, 'Style','popupmenu', 'Units','pixels', ...
						...
						'BackgroundColor', get(theFig,'Color'), ...
						'Enable', 'off', ...
						'Callback', sprintf('rest_sliceviewer(''Magnify'', %g);',theFig.Number), ...
	...
	hMniTal =uicontrol(theFig, 'Style','popupmenu', 'Units','pixels', ...
						...
						'BackgroundColor', get(theFig,'Color'), ...
						'Enable', 'on', ...
						'Callback', sprintf('rest_sliceviewer(''MNI/Talairach'', %g);',theFig.Number), ...
	...
	hMsgLabel =uicontrol(theFig, 'Style','text', 'Units','pixels', ...
			  ...
			  'ButtonDownFcn', sprintf('rest_sliceviewer(''ToggleInfoDisplay'', %g);',theFig.Number), ...
	...
	hViewTransverse =uicontrol(theFig, 'Style','pushbutton',  ...
							  'Units','pixels', ...
							  'Callback', sprintf('rest_sliceviewer(''TransverseView'', %g);',theFig.Number) , ...
							  'CData', theIcon,...
	...
	hViewSagittal =uicontrol(theFig, 'Style','pushbutton',  ...
							  'Units','pixels', ...
							  'Callback', sprintf('rest_sliceviewer(''SagittalView'', %g);',theFig.Number) , ...
							  'CData', theIcon,...
							  'Position',[theLeft, theBottom, 34,36]);
	...
	hViewCoronal =uicontrol(theFig, 'Style','pushbutton',  ...
							  'Units','pixels', ...
							  'Callback', sprintf('rest_sliceviewer(''CoronalView'', %g);',theFig.Number) , ...
							  'CData', theIcon,...
							  'Position',[theLeft, theBottom, 34,36]);
	...
	hViewOrthogonal =uicontrol(theFig, 'Style','pushbutton',  ...
							  'Units','pixels', ...
							  'Callback', sprintf('rest_sliceviewer(''OrthogonalView'', %g);',theFig.Number) , ...
							  'CData', theIcon,...
							  'Position',[theLeft, theBottom, 34,36]);
	...
	hViewMontage =uicontrol(theFig, 'Style','pushbutton',  ...
							  'Units','pixels', ...
							  'Callback', sprintf('rest_sliceviewer(''Montage'', %g);',theFig.Number) , ...
    ...
    hUnderlayRecent =uicontrol(theFig, 'Style','popupmenu', 'Units','pixels', ...
			  ...
			  'Callback', sprintf('rest_sliceviewer(''ClickRecentUnderlay'', %g);',theFig.Number), ...
			  'BackgroundColor', get(theFig,'Color'), ...			  
	...
	hUnderlayFile =uicontrol(theFig, 'Style','edit', 'Units','pixels', ...
							  'String', '', ...
							  'BackgroundColor', 'white', ...
							  'Callback', sprintf('rest_sliceviewer(''ChangeUnderlay'', %g);',theFig.Number), ...
	...
	hULSel=uicontrol(theFig, 'Style','pushbutton', 'Units','pixels', ...
		  'Callback', sprintf('rest_sliceviewer(''UnderlaySelection'', %g);',theFig.Number) , ...
	...
	hOverlayRecent =uicontrol(theFig, 'Style','popupmenu', 'Units','pixels', ...
			  ...
			  'Callback', sprintf('rest_sliceviewer(''ClickRecentOverlay'', %g);',theFig.Number), ...
			  'BackgroundColor', get(theFig,'Color'), ...			  
			  'Position',[theLeft, theBottom, 75,20]);
    ...
    hVolumeIndexLeft =uicontrol(theFig, 'Style','pushbutton','Units','pixels',...
                              'Callback',sprintf('rest_sliceviewer(''ChangeTimePointLeft'', %g);',theFig.Number),...
                              'String','<','FontWeight','bold',...
    ...
    hVolumeIndexText =uicontrol(theFig, 'Style','edit','Units','pixels',...
                              'String', '',...
                              'BackgroundColor','White',...
                              'Callback',sprintf('rest_sliceviewer(''ChangeTimePoint'', %g);',theFig.Number),...
    ...
    hVolumeIndexRight =uicontrol(theFig, 'Style','pushbutton','Units','pixels',...
                              'Callback',sprintf('rest_sliceviewer(''ChangeTimePointRight'', %g);',theFig.Number),...
                              'String','>','FontWeight','bold',...
                              'Position',[theLeft,theBottom,10,20]);
	...
	hOverlayFile =uicontrol(theFig, 'Style','edit', 'Units','pixels', ...
					  'String', '', ...					  
					  'BackgroundColor', 'white', ...
					  'Callback', sprintf('rest_sliceviewer(''ChangeOverlay'', %g);',theFig.Number), ...
					  'Position',[theLeft, theBottom, 150,20]);
	...
	hOLSel=uicontrol(theFig, 'Style','pushbutton', 'Units','pixels', ...
		  'Callback', sprintf('rest_sliceviewer(''OverlaySelection'', %g);',theFig.Number) , ...
		  'String', '...','FontWeight', 'bold', ...
		  'Position',[theLeft, theBottom, 26,15]); 
	...
	hEdtThrdValue =uicontrol(theFig, 'Style','edit', 'Units','pixels', ...
					'String', '', ...					
					'Callback', sprintf('rest_sliceviewer(''Overlay_SetThrdAbsValue'', %g);',theFig.Number), ...	
					 'BackgroundColor', 'white', ...
    ...
    hdf =uicontrol(theFig, 'Style','pushbutton',  ... %add df dong 090921
							  'Units','pixels', ...
							  'Callback', sprintf('rest_sliceviewer(''DF'', %g);',theFig.Number),...	
							  'String', 'df', ...
    ...
    hOnlyP=uicontrol(theFig, 'Style','pushbutton', 'Units','pixels', ...  %only + dong 090921
			'String', '+', ...
			'Callback', sprintf('rest_sliceviewer(''OnlyPositive'', %g);',theFig.Number),...			
			'Position',[theLeft+112, theBottom+80, 15,18]);
    hOnlyN=uicontrol(theFig, 'Style','pushbutton', 'Units','pixels', ...  %only + dong 090921
			'String', '-', ...
			'Callback', sprintf('rest_sliceviewer(''OnlyNegative'', %g);',theFig.Number),...			
	...
	if ~ispc && ~ismac%Added by Sandy to fix a display at UNIX
        hOverlayMisc =uicontrol(theFig, 'Style','popupmenu', 'Units','pixels', ...
					...
					'BackgroundColor', get(theFig,'Color'), ...
					'Enable', 'on', ...
					'Callback', sprintf('rest_sliceviewer(''Overlay_Misc'', %g);',theFig.Number), ...
       ...
       hTemplate =uicontrol(theFig, 'Style','popupmenu', 'Units','pixels', ...
					...
					'BackgroundColor', get(theFig,'Color'), ...
					'Enable', 'on', ...
					'Callback', sprintf('rest_sliceviewer(''Open_Template'', %g);',theFig.Number), ...
					'Position',[theLeft+5, theBottom+35, 140,22]);
       hClusterSize=uicontrol(theFig, 'Style','pushbutton', 'Units','pixels', ...
			'String', 'Cluster Size', ...
			'Callback', sprintf('rest_sliceviewer(''Overlay_SetThrdClusterSize'', %g);',theFig.Number),...		%here dong	
			'Position',[theLeft+5, theBottom+10, 70,24]);
       hSaveCluster=uicontrol(theFig, 'Style','pushbutton', 'Units','pixels', ...
			'String', 'Save Cluster', ...
			'Callback', sprintf('rest_sliceviewer(''CurrentCluster2Mask'', %g);',theFig.Number),...			
       ...
       hSaveClusters=uicontrol(theFig, 'Style','pushbutton', 'Units','pixels', ...%dong 090920
			...
			'Callback', sprintf('rest_sliceviewer(''CurrentThrd2Mask'', %g);',theFig.Number),...			
			'Position',[theLeft+5, theBottom-15, 70,24]);
       hClReport=uicontrol(theFig, 'Style','pushbutton', 'Units','pixels', ...%dong 090920
			'String', 'Cl. Report', ...
            'Callback', sprintf('rest_sliceviewer(''ClustersReport'', %g);',theFig.Number),...				
	...
	%		 'String', 'Thrd2Mask', ...
	%		 'Callback', sprintf('rest_sliceviewer(''Overlay_SetThrdClusterSize'', %g);',theFig.Number),...			
	%		 'Position',[theLeft+75, theBottom+5, 70,24]);
			
	%Colorbar for overlay, do as AFNI, 20070921
	theAxesButtonDownFcn =sprintf('rest_sliceviewer(''ChangeColorElement'', %g);',theFig.Number);
...
%Input: Need AConfig.Filename specified	
	...
	theAxesButtonDownFcn =sprintf('rest_sliceviewer(''ClickPosition'', %g);',AConfig.hFig.Number);
...
% 			end
			if x==1 %&& thePercentValue~=0
                hTextMinNegative=uicontrol(AConfig.hFig, 'Style','edit', 'Units','pixels', ...
					  ...
					  'BackgroundColor', 'white', ...
                      'Callback', sprintf('rest_sliceviewer(''ChangeMinNegative'', %g);',AConfig.hFig.Number),...
...
% 			end
            ...
            if x==theNumberCmd && thePercentValue~=0
                hTextMaxPositive=uicontrol(AConfig.hFig, 'Style','edit', 'Units','pixels', ...
					  ...
					  'BackgroundColor', 'white', ...
                      'Callback', sprintf('rest_sliceviewer(''ChangeMaxPositive'', %g);',AConfig.hFig.Number),...
...
if (evnt.VerticalScrollCount>0),
    % scroll down
    eval(sprintf('rest_sliceviewer(''ScrollWheelDown'', %g);',src.Number));
else
    % scroll up
    eval(sprintf('rest_sliceviewer(''ScrollWheelUp'', %g);',src.Number));
end;
